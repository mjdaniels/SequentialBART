...
test_that("test that output is of correct type",
          { expect_type(serBARTfunc(xx=xx,yy=y1,datatype=datatype, type = 0), "list")
            expect_type(serBARTfunc(xx=xx,yy=y1,datatype=datatype, type = 1), "list")
            expect_type(serBARTfunc(xx=xx,yy=y2,datatype=datatype, type = 2), "list")
            })
