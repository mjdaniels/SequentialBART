...
test_that("test that output is of correct type",
          { expect_type(seqBART(x=xExample, y=y1Example, datatype=datatypeExample, type = 0), "list")
            expect_type(seqBART(x=xExample, y=y1Example, datatype=datatypeExample, type = 1), "list")
            expect_type(seqBART(x=xExample, y=y2Example, datatype=datatypeExample, type = 2), "list")
          })
