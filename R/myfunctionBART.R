...
#' @param m m value
#' @param sigdf sigdf value
#' @param sigquant signquant values
#' @param kfac kdfac value
#'
...
#'
serBARTfunc<- function( xx, yy, datatype, type, numskip=199,burn=1000, m=200,sigdf=3, sigquant=.90, kfac=2.0)
{
  set.seed(12345)
  pp<-ncol(xx)
  n<-nrow(xx)
